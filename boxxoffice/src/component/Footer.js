...
const Footer = () => {
    return (
        <>
            <div className="ka_NW">
                <div className="Container Ay8eh">
                    <div className="Row M6oaW">
                        <div className="gcp3k">
                            <a
                                className="ATag ZQtDc boxxoffice" 
                                href="#"
                                style={{
                                    textDecoration: "none",
                                    fontSize: 20,
                        ...
                        <div className="Col Col--4 Col--lg-3 Col--xl-1-5 Col--xxl-2 B2EMM">
                            <div className="I06GC">
                                <div className="UpphA">
                                    <a
                                        href="https://www.facebook.com/profile.php?id=100009454452522"
                                        rel="noopener"
                                        target="_blank"
                                        className="ATag cPn2e"
                                    >
                                        <svg
                                            className="Z0g3x EviMn"
                                    ...
                                    <a
                                        href="https://www.instagram.com/abhay.sahil/"
                                        rel="noopener"
                                        target="_blank"
                                        className="ATag x4TVQ"
                                    >
                                        <svg
                                            className="Z0g3x"
                                            preserveAspectRatio="xMidYMid meet"
                                    ...
                                    <a
                                        href="https://twitter.com/KumarAbhay98"
                                        rel="noopener"
                                        target="_blank"
                                        className="ATag dscSD"
                                    >
                                        <svg
                                            className="Z0g3x"
                                            preserveAspectRatio="xMidYMid meet"
                                    ...
                                    <a
                                        href="https://www.linkedin.com/in/abhay-kumar-6586b220a"
                                        rel="noopener"
                                        target="_blank"
                                        className="ATag yFrHA"
                                    >
                                        <svg
                                            className="Z0g3x"
                                            preserveAspectRatio="xMidYMid meet"
                    ...
                    <div className="Row BYCDX">
                        <div className="Col Col--4 Col--lg-3 Col--xl-1-5 Col--xxl-2 CgXhT" />
                        <div className="Col Col--4 Col--lg-3 Col--xl-1-5 Col--xxl-2 CgXhT" />
                    </div>
                    <div className="Row XRKgF">
                        <div className="Col Col--4 Col--lg-3 Col--xl-1-5 Col--xxl-2">
                            <ul className="ZIbts">
                                <li className="aBVGi">COMPANY</li>
                                <li>
                                    {" "}
                                    <Link to="/"
                                ...
                                <li>
                                    <a
                                        href="mailto: Abhaycbr07@gmail.com"
                                        rel="noopener"
                                        target="_self"
                                        className="ATag"
                                    >
                    ...
                    <div className="zbLtJ">
                        <div className="EELlk">
                            <a
                                ...
                                rel="noopener"
                                target="_blank"
                                className="ATag pgZbK"
                            />
                            <a
                                href="https://play.google.com/store/apps/details?id=com.tubitv"
                                rel="noopener"
                                target="_blank"
                                className="ATag yPGO9"
                            />
                        </div>
                        <div className="ApbYa copyright">
                            <div className="uo5wS">
                                <div>Copyright © 2022 BoXXoFFice</div>
                                <div>
                                    BoXXoFFice is a registered trademark, Inc. <br /> All rights
                                    reserved.
                                </div>
                            </div>
                            <div className="aUJcG">
                                Device ID: 2f845106-5b00-429b-94e2-6c223b4h5517
                            </div>
                            <div className="aUJcG">Made by: Abhay Kumar</div>
                        </div>
                        <div className="_97LI">
                            Made with{" "}
                            <svg
